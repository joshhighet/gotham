...
The following versions will recieve security updates when identified.
...
Send any correspondance to security@theta.co.nz. The following RSA PGP Key is available if desired.
